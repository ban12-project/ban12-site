  ...
  return (
    <main
      ...
      className={cn(
        ...
        'overflow-auto peer-data-[variant=inset]:min-h-[calc(100svh-(--spacing(4)))] md:peer-data-[variant=inset]:m-2 md:peer-data-[state=collapsed]:peer-data-[variant=inset]:ml-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-xs',
        className,
      )}
      {...props}
    />
...
const SidebarInput = (
  ...
  return (
    <Input
      ...
      data-sidebar="input"
      className={cn(
        'focus-visible:ring-sidebar-ring h-8 w-full bg-white shadow-none focus-visible:ring-2 dark:bg-slate-950',
        className,
      )}
      {...props}
    />
